...
const EVENT_VOLUME_DB: Dictionary[StringName, float] = {
	...
	&"ui_hover": -14.0,
	&"ui_blocked": -8.0,
	&"not_enough_resources": -6.0,
	&"object_selected": -8.0,
	&"build_success": -8.0,
	
	&"scan_drone_launch": -7.0,
	&"scan_drone_arrive": -8.0,
	&"scan_loop": -8.0,
	&"scan_complete": -7.0,
	&"resource_revealed": -6.0,
	
	&"mining_ship_launch": -7.0,
	&"mining_ship_arrive": -8.0,
	&"mining_resource_tick": -8.0,
	&"mining_complete": -25,
	&"ship_return": -8.0,
	&"cargo_unload": -30.0,
